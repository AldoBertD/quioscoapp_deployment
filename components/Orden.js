    ...
    return (
        <div className="border p-10 space-y-5">
            ...
            <div className="md:flex md:items-center md:justify-between my-10">
                <p className="mt-2 font-bold text-2xl text-amber-500">
                    Total a pagar: {formatearDinero(total)}
                </p>
                <button className="bg-indigo-600 hover:bg-indigo-800 text-white mt-5 md:mt-0 py-3 px-10 uppercase font-bold rounded-md" type="button" onClick={completarOrden}>
                    Completar Orden
                </button>
            </div>
        </div>
